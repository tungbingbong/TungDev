<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_product_price.ascx.cs"
    Inherits="admincp_modules_mod_product_mod_add_edit_product_price" %>
                        ...
                        <td>
                            ...
                            <table class="title" cellpadding="3" cellspacing="3">
                                <tr>
                                    ...
                                    <td width="95%">
                                        <span class="title">Quản trị danh sách báo giá</span>
                                    </td>
                                </tr>
                            </table>
                            <table class="content">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="form">
                                                        ...
                                                        <tr>
                                                            <th>
                                                                Tên báo giá :<span class="note">*</span>
                                                            </th>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <CKEditor:CKEditorControl ID="CKEditor_Mota" runat="server"></CKEditor:CKEditorControl>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">
                                                            ...
                                                            <td>
                                                                <input id="uploadAttach" style="width: 291px; height: 22px" type="file" size="50"
                                                                    runat="server" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Panel ID="PnAttach" runat="server" Visible="false">
                                                                    ...
                                                                    [ <a href="Default.aspx?page=add_edit_product_price&mod=product&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delAttach">
                                                                        Xóa File này </a>]
                                                                </asp:Panel>
                                                            </td>
                                                        </tr>
