<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_adv.ascx.cs" Inherits="admincp_modules_mod_adv_mod_add_edit_adv" %>
			...
			<tr>
	            ...
	            <table class="title" cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td width="95%"><span class="title">Quản trị logo Adv - Images</span></td>
                    </tr>    		
                </table>
                <table class="content">
                    <tr>
		                        ...
		                        <tr>
			                        <td >
				                        ...
				                        <table class="form">
					                        ...
					                        <tr>
						                        <th>Chữ nhỏ :<span class="note">*</span></th>
						                        <td><asp:TextBox runat="server" type="text" size="70" id="txtShortName"></asp:TextBox></td>
					                        </tr>
					                        <tr>
						                        <th>Đường dẫn :<span class="note">*</span></th>
					                        ...
					                        <tr>
						                        ...
						                        <option value="4">Top banner</option>
						                        </select>
						                        </td>
					                        </tr>
					                        <tr>
					                        ...
					                        <tr>
				                               ...
				                               <td>
						                            ...
						                            <img src="images/b_drop.png"  /> [ <a href="Default.aspx?page=add_edit_adv&mod=adv&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delImg&getpage=<%= clsInput.getNumericInput("getpage",0) %>"> Xóa ảnh này </a> ]
					                            </asp:Panel>
				                               </td>
				                            </tr>
				                        </table>
