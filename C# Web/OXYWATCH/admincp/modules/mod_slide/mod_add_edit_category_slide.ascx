<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_category_slide.ascx.cs" Inherits="admincp_modules_mod_slide_mod_add_edit_category_slide" %>
                        ...
                        <td>
                            ...
                            <table class="title" cellpadding="3" cellspacing="3">
                                <tr>
                                    ...
                                    <td width="95%">
                                        <span class="title">Quản trị danh mục loại slide</span>
                                    </td>
                                </tr>
                            </table>
                            <table class="content">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="right" width="100%" valign="bottom">
                                                                <a href="Default.aspx?page=category_slide&mod=slide" title="Danh sách danh mục">
