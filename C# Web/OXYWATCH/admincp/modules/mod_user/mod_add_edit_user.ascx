<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_user.ascx.cs" Inherits="admincp_modules_mod_user_mod_add_edit_user" %>
			...
			<tr>
	            ...
	            <table class="title" cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td width="95%"><span class="title">Quản trị thông tin người dùng</span></td>
                    </tr>    		
                </table>
                <table class="content">
                    <tr>
                        <td>
	                        <table class="header" cellpadding="0" cellspacing="0">
		                        <tr>
			                        <th>Thêm - Sửa thông tin người dùng</th>
		                        </tr>	
	                        </table>
