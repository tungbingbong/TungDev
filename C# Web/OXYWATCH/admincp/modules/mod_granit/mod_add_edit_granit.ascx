<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_granit.ascx.cs" Inherits="admincp_modules_mod_granit_mod_add_edit_granit" %>
			...
			<tr>
	            ...
	            <table class="title" cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td width="95%"><span class="title">Quản trị danh sách các loại đá</span></td>
                    </tr>    		
                </table>
                <table class="content">
                    <tr>
		                        ...
		                        <tr>
			                        <td >
				                        ...
				                        <table class="form">
					                        ...
					                        <!-- END block_error -->
					                        <tr>
						                        <th>Tên loại đá :<span class="note">*</span></th>
					                        ...
					                        <tr>
				                               ...
				                               <td>
						                            ...
						                            <img src="images/b_drop.png"  /> [ <a href="Default.aspx?page=add_edit_granit&mod=granit&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delImg"> Xóa ảnh này </a> ]
					                            </asp:Panel>
				                               </td>
				                            </tr>
				                        </table>
