<%@ Control Language="C#" AutoEventWireup="true" CodeFile="view_hoadon.ascx.cs" Inherits="admincp_modules_mod_hoadon_view_hoadon" %>
				                ...
				                %>
				                        <table class="form">
					                        ...
					                        <tr>
						                        <th>Tên truy nhập :</th>
						                        <td>
						                        <%= dt.Rows[0]["C_CustommerName"].ToString() %>
						                        </td>
					                        </tr>					                        
					                        <tr>
						                        <th>Họ tên :</th>
