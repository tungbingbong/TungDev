<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_category_nhaxuong.ascx.cs" Inherits="admincp_modules_mod_nhaxuong_mod_add_edit_category_nhaxuong" %>
			...
			<tr>
	            ...
	            <table class="title" cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td width="95%"><span class="title">Quản trị danh mục nhà xưởng</span></td>
                    </tr>    		
                </table>
                <table class="content">
                    <tr>
			                        ...
			                        <td >
				                        <table width="100%">
					                        <tr>
						                        ...
						                        <a href="Default.aspx?page=category_nhaxuong&mod=nhaxuong" title="Danh sách danh mục"><img src="images/icons/list.gif" class="icon" ></a>&nbsp;&nbsp;&nbsp;
