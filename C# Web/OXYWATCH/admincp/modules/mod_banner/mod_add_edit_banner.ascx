<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_banner.ascx.cs" Inherits="admincp_modules_mod_banner_mod_add_edit_banner" %>
                        ...
                        <td>
                            ...
                            <table class="title" cellpadding="3" cellspacing="3">
                                <tr>
                                    ...
                                    <td width="95%">
                                        <span class="title">Quản trị danh sách các banner</span>
                                    </td>
                                </tr>
                            </table>
                            <table class="content">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <table class="form">
                                                        ...
                                                        <tr>
                                                            <th>
                                                                Tên banner:<span class="note">*</span>
                                                            </th>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <th>
                                                                Loại banner:<span class="note">*</span>
                                                            </th>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox runat="server" type="text" size="70" ID="txtUrl"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Panel ID="PnImg" runat="server" Visible="false">
                                                                    ...
                                                                    [ <a href="Default.aspx?page=add_edit_banner&mod=banner&do=edit&id=<%= clsInput.getNumericInput("id",0) %>&act=delImg">
                                                                        Xóa ảnh này </a>]
                                                                </asp:Panel>
                                                            </td>
                                                        </tr>
