<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mod_add_edit_category_banner.ascx.cs" Inherits="admincp_modules_mod_banner_mod_add_edit_category_banner" %>
                        ...
                        <td>
                            ...
                            <table class="title" cellpadding="3" cellspacing="3">
                                <tr>
                                    ...
                                    <td width="95%">
                                        <span class="title">Quản trị danh mục loại banner</span>
                                    </td>
                                </tr>
                            </table>
                            <table class="content">
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="right" width="100%" valign="bottom">
                                                                <a href="Default.aspx?page=category_banner&mod=banner" title="Danh sách danh mục">
                                                                    <img src="images/icons/list.gif" class="icon"></a>&nbsp;&nbsp;&nbsp; <a href="#"
                                                                        onclick="window.location.reload();" title="{src_refresh}">
                                                    ...
                                                    <table class="form">
                                                        ...
                                                        <tr>
                                                            <th>
                                                                Tên danh mục :<span class="note">*</span>
                                                            </th>
                                                            <td>
