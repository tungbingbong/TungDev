...
public partial class admincp_modules_mod_resquest_mod_add_edit_resquest : System.Web.UI.UserControl
{
    ...
    private void edit_category_news(int intID)
    {
        ...
        //Dropdown
        DataTable dtCategory = clsDatabase.getDataTable("select * from tbl_category_news where FK_ParentID = 0 AND FK_LangID = " + lang.getLangID() + " and C_PointUrl = 0 " + " AND PK_CategoryID <> " + intID + " order by C_Rank desc");
    ...
    private void add_category_news()
    {
        ...
        //Dropdown
        DataTable dtCategory = clsDatabase.getDataTable("select * from tbl_category_news where FK_ParentID = 0 and FK_LangID = " + lang.getLangID() + " and C_PointUrl = 0 " + " order by C_Rank desc");
        DrdCategory.Items.Clear();
        DrdCategory.Items.Add(new ListItem("", "0"));
        int intSelected = 0;
        // Response.Write();
