...
<iframe src="<?php echo $dato; ?>" allowfullscreen="true"scrolling="no" frameborder="0"></iframe>
<?php }?>
...
echo '<iframe src="https://kizyplayer.com/embed/'.$values.'/"allowfullscreen="true" scrolling="no" frameborder="0"></iframe>';
?>
...
<div class="movieplay">
	...
	<?php
$values = info_movie_get_meta( 'Title' );
$values = str_replace(' ', '-', $values);
$values = str_replace( ':','',  $values);

echo '<iframe src="https://putstream.com/movie/'.$values.'/"height="100%"allowfullscreen="true" scrolling="no" frameborder="0"></iframe>';
?>
