...
<a href="<?php echo get_permalink(); ?>#mv-info" class="btn bp-btn-light" <?php if (is_single() && is_post_type('tvshows')){?>style="display:none;"<?php }?>><i class="fa fa-lightbulb-o" ></i> <span></span></a>
<?php }?>
