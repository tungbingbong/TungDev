...
<img data-original="<?php echo $imgsrc; $imgsrc = ''; ?>   <?php echo info_movie_get_meta('poster_url'); ?> <?php echo episodios_get_meta('poster_serie'); ?>" class="lazy thumb mli-thumb" alt="<?php the_title(); ?>">
