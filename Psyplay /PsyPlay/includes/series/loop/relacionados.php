...
<div class="jtip-top">
                 <?php if($dato = series_get_meta('serie_vote_average')) { ?> <div class="jt-info jt-imdb">  TMDb: <?php echo $dato; ?></div><?php } ?>
  ...
  <?php if($dato = series_get_meta('episode_run_time')) { ?><div class="jt-info"><?php echo $dato; ?> min</div><?php } ?>
    <div class="clearfix"></div>
</div>
 <?php the_excerpt(); ?>

     <?php if($mostrar = $terms = strip_tags( $terms = get_the_term_list( $post->ID, 'country' ))) {  ?> <p><div class="block"> <?php echo get_the_term_list($post->ID, 'country', 'Country: ', ',', ''); ?></div><?php } ?>
