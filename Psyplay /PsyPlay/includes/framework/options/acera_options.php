...
array("section" => "homepage", "type" => "heading","title" => __( "Featured Slider Module", "psythemes" ),"id" => "sli-module"),
...
array(
    ...
    "type" => "radio", //Required
    "name" => __( "Filter Movies by: Category", "psythemes" ), //Required
...
array(
    "under_section" => "sli-module", //Required
    "type" => "number", //Required
    "name" => __("Category ID","psythemes"), //Required
    "id" => "estrenos_cat", //Required
	"display_checkbox_id" => "toggle_checkbox_id",
    "desc" => __("Category ID (Numeric) of the featured movies","psythemes")
),
array(
    "under_section" => "sli-module", //Required
    "type" => "number", //Required
    "name" => __("Featured Movies Amount","psythemes"), //Required
...
array(
    ...
    "placeholder" => __("Category ID (Numeric) of the featured movies","psythemes"),
    "desc" => __("Category ID (Numeric) of the featured movies","psythemes"),
	"default" => ("16")),
	array(
    "under_section" => "sugg-module", //Required
...
array(
    "under_section" => "sugg-module",
    "type" => "checkbox",
    "name" => __("Filter by: Category", "psythemes"),
    "id" => array("sugg-filterby-cat"),
...
array(
    ...
    "desc" => __("Category ID (Numeric) of the featured movie sub module.","psythemes"),
),
