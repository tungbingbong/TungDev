...
<h3 class="footer-link-head"><?php if ($url = get_option('social_title_footer') ) { echo $url; } else { echo 'Stay Connected' ;} ?></h3>
                    ...
                    <div class="form-subs mt20"><div id="social-foot" class="footer-social"><a href="<?php if ($url = get_option('social_fb_footer') ) { echo $url; } else { echo '#' ;} ?>" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
<a href="<?php if ($url = get_option('social_tw_footer') ) { echo $url; } else { echo '#' ;} ?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
<a href="<?php if ($url = get_option('social_gp_footer') ) { echo $url; } else { echo '#' ;} ?>" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
  <a href="<?php if ($url = get_option('social_yt_footer') ) { echo $url; } else { echo '#' ;} ?>" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a></div><div class="clearfix"></div>
                    </div>
...
<?php } ?>
                    ...
                    <p><?php psy_footer_copyrights(); ?> Designed by <a href='http://infitheme.com/'>infi Themes</a></p>
