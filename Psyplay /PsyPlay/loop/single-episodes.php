...
<?php get_template_part('includes/series/loop/player'); ?>
</div>
...
<p><strong>Serie: </strong> <a href="<?php bloginfo('url'); ?>/<?php echo get_option('tvshows-slug'); ?>/<?php echo sanitize_title(episodios_get_meta('serie')); ?>"><span itemprop="partOfSeries"><?php echo $dato; ?></span></a></p>
<?php }?>	
