...
<?php }?> 			
<div id="mv-info">
<div id="content-cover" style="background-image:url(<?php if($fondo = series_get_meta('fondo_player')) { echo $fondo; } else { echo get_template_directory_uri().'/images/cover.jpg'; } ?>)"></div>
