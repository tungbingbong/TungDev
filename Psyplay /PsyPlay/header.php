...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-106834212-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments)};
  gtag('js', new Date());

  gtag('config', 'UA-106834212-1');
</script>
<meta name="google-site-verification" content="0o5v2bQrwyn2vVSGaN-i7bUQ9A_GGWyBR5ZMQFhIQtU" />
...
<input class="form-control search-input" type="text" placeholder="<?php _e('Search..', 'psythemes'); ?>" name="s" id="s" value="<?php echo $_GET['s'] ?>">
