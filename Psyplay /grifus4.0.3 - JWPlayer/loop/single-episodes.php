...
<li><a class="info" href="#info"><?php _e('Information','mundothemes'); ?></a></li>
<li><a class="info selected" href="#streaming"><?php _e('Videos','mundothemes'); ?></a></li>
...
<?php
    ...
    $urlen = $encrypted_txt;
	echo '<iframe style="border: 0px #FFFFFF none;" src="//sibeol.com/e/wp-embed.php?url='.$urlen.'" width="100%" height="100%" frameborder="0" marginwidth="0px" marginheight="0px" scrolling="no" allowfullscreen="allowfullscreen"></iframe>';
?>
<?php } ?>
