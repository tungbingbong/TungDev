...
<h2><?php _e('Mundothemes License','mundothemes'); ?> | Custom By Sultan ( CUSTOM )</h2>
...
<?php }
function dwnld() { ?>
<a class="ssocial facebook" style = "background-color: #5cb85c; color:white; border-radius: 3px;;" href="http://nullrefer.com/?https://subscene.com/subtitles/title?q=<?php the_title(); ?>" target="_blank"><b class="fa fa-align-justify"></b><?php _e('  Download Subtitle','mundothemes'); ?></a>
<a class="ssocial twitter" style = "background-color: #cf413b; color:white; border-radius: 3px;;" href="http://nullrefer.com/?http://1337x.to/search/<?php the_title(); ?> <?php $date = date_create(info_movie_get_meta("Released")); echo date_format($date, 'Y'); ?>/1/" target="_blank"><b class="fa fa-cloud-download"></b><?php _e('  Download Torrent','mundothemes'); ?></a>
<?php }
function laterales() { ?>
