				...
				<div class="card">
					...
					<div class="card-body">
						<div class="mx-auto d-block">
							...
							<div class="location text-sm-center">
								<i class="fa fa-map-marker"></i> ${user.city}, ${user.nationality}
							</div>
						</div>
						<hr>
						...
						<hr>
						<a href="<c:url value='/customer/profile/edit'/>"><i class="fa fa-edit"></i> Edit Profile &emsp; &emsp; &emsp;</a> 
						<a href="<c:url value='/customer/profile/change-password'/>"><i class="fa fa-key"></i> Change password</a>
					</div>
				</div>
			</div>
		</div>
