...
if( $nv_Request->get_int( 'save', 'post,get', 0 ) )
{
	...
	$data['gia_1'] = $nv_Request->get_title( 'gia_1', 'post', '', 1 );
	$data['mieuta_gia_1'] = $nv_Request->get_title( 'mieuta_gia_1', 'post', '', 1 );
	$data['gia_2'] = $nv_Request->get_title( 'gia_2', 'post', '', 1 );
	$data['mieuta_gia_2'] = $nv_Request->get_title( 'mieuta_gia_2', 'post', '', 1 );
	$data['gia_3'] = $nv_Request->get_title( 'gia_3', 'post', '', 1 );
	$data['mieuta_gia_3'] = $nv_Request->get_title( 'mieuta_gia_3', 'post', '', 1 );
	...
	if( empty( $error ) )
	{
		if( $data['id'] > 0 )
		{
			$stmt = $db->prepare( 'UPDATE ' . NV_PREFIXLANG . '_' . $module_data . '_rows SET
				...
				urlimg =:urlimg,
				gia_1=:gia_1,
				mieuta_gia_1=:mieuta_gia_1,
				gia_2=:gia_2,
				mieuta_gia_2=:mieuta_gia_2,
				gia_3=:gia_3,
				mieuta_gia_3=:mieuta_gia_3,
			...
			$stmt->bindParam( ':gia_1', $data['gia_1'], PDO::PARAM_STR );
			$stmt->bindParam( ':mieuta_gia_1', $data['mieuta_gia_1'], PDO::PARAM_STR );
			$stmt->bindParam( ':gia_2', $data['gia_2'], PDO::PARAM_STR );
			$stmt->bindParam( ':mieuta_gia_2', $data['mieuta_gia_2'], PDO::PARAM_STR );
			$stmt->bindParam( ':gia_3', $data['gia_3'], PDO::PARAM_STR );
			$stmt->bindParam( ':mieuta_gia_3', $data['mieuta_gia_3'], PDO::PARAM_STR );
