...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows (
  ...
  gia_1 varchar(255) NOT NULL,
  mieuta_gia_1 varchar(255) NOT NULL,
  gia_2 varchar(255) NOT NULL,
   mieuta_gia_2 varchar(255) NOT NULL,
  gia_3 varchar(255) NOT NULL,
   mieuta_gia_3 varchar(255) NOT NULL,
