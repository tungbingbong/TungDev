...
$page_title = $global_weblinks_cat[$catid]['title'];
$key_words = $global_weblinks_cat[$catid]['keywords'];
$description = $global_weblinks_cat[$catid]['description'];

$items = array();
$array_subcat = array();
$array_cat = array();
foreach ($global_weblinks_cat as $array_cat_i) {
...
$array_cat[] = array(
    'title' => $global_weblinks_cat[$catid]['title'],
    'link' => $global_weblinks_cat[$catid]['link'],
    'description' => $global_weblinks_cat[$catid]['description']
);
...
$base_url = $global_weblinks_cat[$catid]['link'];
...
while ($row = $result->fetch()) {
    ...
    $row['link'] = $global_weblinks_cat[$catid]['link'] . '/' . $row['alias'] . '-' . $row['id'];
