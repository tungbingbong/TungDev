...
if (! empty($row['sender_goidichvu'])) {
    $xtpl->parse('main.sender_goidichvu');
}
if (! empty($row['sender_khuvuc'])) {
    $xtpl->parse('main.sender_khuvuc');
}
if (! empty($row['sender_dientich'])) {
    $xtpl->parse('main.sender_dientich');
}
