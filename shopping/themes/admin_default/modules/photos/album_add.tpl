                     ...
                     <div class="tab-pane active" id="tab-general">
						<ul class="glt-upload-step clearfix">
								<li class="active">
									...
									<span class="steptext">Bước 1: Tạo Khách hàng</span>
								</li>
								<li>
									<span class="stepicon"><span>&nbsp;</span></span>
						...
						<div class="form-group">
								...
								<div class="col-sm-20">
									<input type="text" name="capturedate" value="{DATA.capturedate}" placeholder="{LANG.album_capturedate}" id="input-date-album1" class="form-control" maxlength="10"/>
 								</div>
						</div>
						<div class="form-group">
