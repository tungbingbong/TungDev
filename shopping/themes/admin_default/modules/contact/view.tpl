	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			<tr>
				...
				<!-- END: sender_phone -->
                	<br />
				<!-- BEGIN: sender_goidichvu -->
				{LANG.goidichvu}: {DATA.sender_goidichvu}
				
				<!-- END: sender_goidichvu -->
                <br />
				<!-- BEGIN: sender_khuvuc -->
				{LANG.khuvuc}: {DATA.sender_khuvuc}
				
				<!-- END: sender_khuvuc -->
                <br />
				<!-- BEGIN: sender_dientich -->
				{LANG.dientich}: {DATA.sender_dientich}
				<br />
				<!-- END: sender_dientich -->
